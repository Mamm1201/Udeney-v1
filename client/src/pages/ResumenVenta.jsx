    ...
    const fetchArticulo = async () => {
      try {
        const res = await axios.get(
          `http://localhost:8000/api/v1/articulos/${id}/`
        );
      ...
      <Box sx={{ maxWidth: 1100, mx: 'auto', mt: 4, p: 3, minHeight: '80vh' }}>
        ...
        >
          ...
          <Typography variant="body2">
            Este es un resumen de tu publicación. Puedes revisarla, y si deseas
            modificarla, accede desde <strong>Mis artículos</strong>.
          </Typography>
        </Box>
