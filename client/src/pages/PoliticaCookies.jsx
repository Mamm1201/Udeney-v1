    ...
    <div className="bg-green-100 min-h-screen flex flex-col">
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 text-justify text-sm leading-relaxed flex-grow">
        <p>
          ...
          utilizamos en nuestra plataforma <strong>Eduney</strong>, y tus
          opciones para gestionarlas.
        </p>
        ...
        <p>
          ...
          colocar en tu dispositivo para almacenar información sobre tus
          preferencias o actividad.
        </p>
        ...
        <p>
          ...
          interactúan los usuarios con el sitio.
          <br />
          <strong>Cookies de personalización:</strong> Recuerdan tus
          preferencias para mejorar tu experiencia.
        </p>
        ...
        <p>
          Utilizamos cookies para garantizar el funcionamiento técnico del
          sitio, analizar el tráfico web y ofrecer contenido personalizado.
        </p>

        <h2 className="text-lg font-semibold mt-6">4. Gestión de cookies</h2>
        <p>
          Puedes configurar tu navegador para aceptar o rechazar el uso de
          cookies. Ten en cuenta que desactivar algunas cookies puede afectar el
          funcionamiento del sitio.
        </p>

        <h2 className="text-lg font-semibold mt-6">5. Cookies de terceros</h2>
        <p>
          Podemos usar servicios externos como Google Analytics, que también
          utilizan cookies para recopilar información anónima sobre el uso del
          sitio.
        </p>

        <h2 className="text-lg font-semibold mt-6">6. Actualizaciones</h2>
        <p>
          Esta Política de Cookies puede ser actualizada. Te recomendamos
          revisarla periódicamente para estar informado sobre cómo usamos las
          cookies.
        </p>
