    ...
    <div className="bg-green-100 min-h-screen flex flex-col">
      ...
      <header className="bg-green-600 text-white py-8">
        <div className="container mx-auto text-center">
          ...
          <p className="mt-2 text-sm">
            Conoce la información legal sobre el uso de nuestra plataforma Eduney.
          </p>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8 text-justify text-sm leading-relaxed flex-grow">
        ...
        <p>
          ...
          comercio electrónico, se informa que el sitio web <strong>Eduney</strong> (en adelante,
          "la Plataforma") es propiedad de Mi Empresa (en adelante, "el Titular").
        </p>

        <h3 className="text-lg font-semibold mt-6">1. Información del titular</h3>
        <p>
          <strong>Nombre comercial:</strong> Eduney<br />
          <strong>Titular:</strong> Mi Empresa<br />
          <strong>Correo electrónico de contacto:</strong> contacto@eduney.com<br />
          <strong>Actividad:</strong> Plataforma de compraventa de artículos escolares de segunda mano.
        </p>

        <h3 className="text-lg font-semibold mt-6">2. Usuarios</h3>
        <p>
          El acceso y/o uso de este sitio web atribuye la condición de Usuario, lo
          que implica la aceptación plena y sin reservas del presente Aviso Legal.
        </p>

        <h3 className="text-lg font-semibold mt-6">3. Objeto</h3>
        <p>
          A través de la Plataforma, el Titular facilita a los usuarios el acceso
          y uso de distintos servicios relacionados con la publicación, búsqueda y
          compraventa de artículos escolares de segunda mano.
        </p>
        ...
        <p>
          Todos los contenidos del sitio (textos, imágenes, logos, diseño gráfico,
          etc.) son propiedad del Titular o de terceros con licencia, y están
        ...
        <p>
          ...
          se hace responsable del contenido, veracidad o disponibilidad de dichos
          sitios externos.
        </p>
