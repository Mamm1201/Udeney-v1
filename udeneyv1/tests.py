...
from django.contrib.auth.models import User  # Usa el modelo de usuario de Django
from .models import Transacciones, Usuarios, DetalleTransaccion
...
class HistorialTransaccionesTest(TestCase):
    def setUp(self):
        ...
        self.detalle_compra = DetalleTransaccion.objects.create(tipo_transaccion="compra")
    ...
    def test_filtro_por_fecha(self):
        ...
        url = reverse("historial_transacciones") + "?fecha_inicio=2024-03-01&fecha_fin=2024-03-31"
        ...
        self.assertContains(response, str(self.transaccion.fecha_transaccion.date()))
