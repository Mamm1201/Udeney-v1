...
from .metrics import SystemMetrics, export_metrics_to_prometheus, metrics
    ...
    def get(self, request):
        ...
        try:
            ...
            if analysis_type in ["all", "cache"]:
                ...
                cache_data = {
                    name: data
                    for name, data in cache_metrics.items()
...
class MetricsDashboardAPIView(APIView):
    ...
    def _calculate_kpis(self, summary):
        ...
        kpis["cache_hit_rate"] = (
            (cache_hits / cache_total * 100) if cache_total > 0 else 0
        )
