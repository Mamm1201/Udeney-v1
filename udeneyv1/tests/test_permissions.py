...
from udeneyv1.permissions import (ArticuloPermissions, IsComprador, IsOwnerOrReadOnly,
                                  IsVendedor, IsVendedorOrReadOnly,
                                  TransaccionPermissions, comprador_required,
                                  get_user_roles, user_has_role, vendedor_required)
...
class ArticuloPermissionsTest(PermissionsBaseTest):
    ...
    def test_propietario_puede_editar_articulo(self):
        ...
        self.assertTrue(permission.has_object_permission(request, None, self.articulo))
    ...
    def test_no_propietario_no_puede_editar_articulo(self):
        ...
        self.assertFalse(permission.has_object_permission(request, None, self.articulo))
