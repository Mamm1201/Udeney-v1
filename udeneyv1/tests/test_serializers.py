...
from udeneyv1.serializers import (ArticulosSerializer, CategoriasSerializer,
                                  UsuariosSerializer)
...
class UsuariosSerializerTest(TestCase):
    ...
    def test_serializer_missing_required_fields(self):
        ...
        incomplete_data = {"nombres_usuario": "Test"}
...
class SerializerIntegrationTest(TestCase):
    ...
    def test_serializers_import_correctly(self):
        ...
        from udeneyv1.serializers import (ArticulosSerializer, CalificacionesSerializer,
                                          CategoriasSerializer, RolesSerializer,
