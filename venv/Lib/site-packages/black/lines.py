...
class Line:
    ...
    def is_comment(self) -> bool:
        ...
        return len(
            self.leaves) == 1 and self.leaves[0].type == STANDALONE_COMMENT
    ...
    def contains_unsplittable_type_ignore(self) -> bool:
        ...
        last_line = next(
            (leaf.lineno for leaf in reversed(
                self.leaves) if leaf.lineno != 0), 0)
...
class EmptyLineTracker:
        ...
        if previous_def is not None:
            ...
            if self.mode.is_pyi:
                if previous_def.is_class and not previous_def.is_stub_class:
                    ...
                    # Empty lines between attributes and methods should be
                    # preserved.
    ...
    def _maybe_empty_lines_for_class_or_def(  # noqa: C901
        ...
        if self.mode.is_pyi:
            ...
            # new lines. This is useful for instance for @overload or
            # Protocols.
...
def is_line_short_enough(  # noqa: C901
    ...
    if str_width(first) > mode.line_length or str_width(
            last) > mode.line_length:
        return False
