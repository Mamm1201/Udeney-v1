...
class Context:
    ...
    def __init__(
        ...
        self._opt_prefixes: t.Set[str] = set(
            parent._opt_prefixes) if parent else set()
        ...
        self.default_map: t.Optional[t.MutableMapping[str,
                                                      t.Any]] = default_map
    ...
    def call_on_close(
            self, f: t.Callable[..., t.Any]) -> t.Callable[..., t.Any]:
    ...
    def lookup_default(self, name: str,
                       call: bool = True) -> t.Optional[t.Any]:
...
class MultiCommand(Command):
    ...
    def resolve_command(
        ...
        if cmd is None and not ctx.resilient_parsing:
            ...
            ctx.fail(
                _("No such command {name!r}.").format(
                    name=original_cmd_name))
...
class Parameter:
    ...
    def __init__(self,
                 ...
                 type: t.Optional[t.Union[types.ParamType,
                                          t.Any]] = None,
                 required: bool = False,
                 default: t.Optional[t.Union[t.Any,
                                             t.Callable[[],
                                                        t.Any]]] = None,
                 callback: t.Optional[t.Callable[[Context,
                                                  "Parameter",
                                                  t.Any],
                                                 t.Any]] = None,
                 ...
                 is_eager: bool = False,
                 envvar: t.Optional[t.Union[str,
                                            t.Sequence[str]]] = None,
                 shell_complete: t.Optional[t.Callable[[Context,
                                                        "Parameter",
                                                        str],
                                                       t.Union[t.List["CompletionItem"],
                                                               t.List[str]],
                                                       ]] = None,
                 ) -> None:
    ...
    def type_cast_value(self, ctx: Context, value: t.Any) -> t.Any:
        ...
        if self.nargs == 1 or self.type.is_composite:
            ...
            def convert(value: t.Any) -> t.Any:  # t.Tuple[t.Any, ...]
                return tuple(self.type(x, self, ctx)
...
class Option(Parameter):
    ...
    def __init__(
        ...
        **attrs: t.Any,
        ...
        if prompt is True:
            ...
            prompt_text: t.Optional[str] = self.name.replace(
                "_", " ").capitalize()
        ...
        self.is_bool_flag: bool = is_flag and isinstance(
    ...
    def _parse_decls(
        ...
        if name is None:
            ...
            raise TypeError(
                f"Could not determine name for option with declarations {
                    decls!r}")
    ...
    def _parse_decls(
        ...
        if not decls:
            if not expose_value:
                return None, [], []
            raise TypeError(
                "Argument is marked as exposed, but does not have a name.")
        if len(decls) == 1:
            name = arg = decls[0]
