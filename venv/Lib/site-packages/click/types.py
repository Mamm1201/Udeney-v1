...
class Choice(ParamType):
    ...
    def shell_complete(
        ...
        if self.case_sensitive:
            ...
            matched = (
                c for c in str_choices if c.lower().startswith(incomplete))
...
class DateTime(ParamType):
    ...
    def _try_to_convert_date(
            self,
            value: t.Any,
            format: str) -> t.Optional[datetime]:
        try:
...
class BoolParamType(ParamType):
    ...
    def convert(
        ...
        self.fail(
            _("{value!r} is not a valid boolean.").format(
...
class UUIDParameterType(ParamType):
    ...
    def convert(
        ...
        try:
            ...
            self.fail(
                _("{value!r} is not a valid UUID.").format(
                    value=value), param, ctx)
...
class File(ParamType):
    ...
    def resolve_lazy_flag(
            self, value: "t.Union[str, os.PathLike[str]]") -> bool:
...
class Tuple(CompositeParamType):
    ...
    def __init__(
            self, types: t.Sequence[t.Union[t.Type[t.Any], ParamType]]) -> None:
...
def convert_type(ty: t.Optional[t.Any],
                 default: t.Optional[t.Any] = None) -> ParamType:
