...
def make_pass_decorator(
    ...
    def decorator(
            f: "t.Callable[te.Concatenate[T, P], R]") -> "t.Callable[P, R]":
        def new_func(*args: "P.args", **kwargs: "P.kwargs") -> "R":
...
def confirmation_option(*param_decls: str, **
                        kwargs: t.Any) -> t.Callable[[FC], FC]:
...
def password_option(*param_decls: str, **
                    kwargs: t.Any) -> t.Callable[[FC], FC]:
